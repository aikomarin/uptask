(function() {
    ...
    function mostrarAlerta(mensaje, tipo, referencia) {
        // Prevenir creación de múltiples alertas
        ...
        referencia.parentElement.insertBefore(alerta, referencia.nextElementSibling); // Insertar la alerta antes del legend. appendchild lo coloca dentro de legend (está mal)
    ...
    async function agregarTarea(tarea) {
        ...
        try {
            const url = '/api/tarea';
            const respuesta = await fetch(url, { // await: realizar la conexión hacia la API
                method: 'POST',
                body: datos
            });
            const resultado = await respuesta.json();
